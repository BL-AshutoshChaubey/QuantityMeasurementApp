...
public class QuantityTest {
    ...
    void given0InchesAnd0Inches_ShouldReturnEqual() {
        Quantity inch1 = new Quantity(0.0, MeasurementUnit.INCHES);
        Quantity inch2 = new Quantity(0.0, MeasurementUnit.INCHES);
        assertEquals(inch1, inch2);
    }

    @Test
    void given1FootAnd12Inches_ShouldReturnEqual() {
        Quantity foot = new Quantity(1.0, MeasurementUnit.FEET);
        Quantity inch = new Quantity(12.0, MeasurementUnit.INCHES);
    ...
    void given1FootAnd1Inch_ShouldReturnNotEqual() {
        Quantity foot = new Quantity(1.0, MeasurementUnit.FEET);
        Quantity inch = new Quantity(1.0, MeasurementUnit.INCHES);
